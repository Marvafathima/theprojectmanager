...
import { logout,signup,login} from "../slice/authSlice";
    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
     {isAuthenticated ==true ? (<>
      ...
      >
        ...
        <a href="/admindashboard" className="flex items-center font-extralight text-lg">
         Admin Dashboard
        </a>
      </Typography>
      ...
      >
        ...
        <a href="/adminlogin" className="flex items-center font-extralight text-lg">
         Admin Login
        </a>
      </Typography>
     </>) }
